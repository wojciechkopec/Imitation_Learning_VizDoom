...
Zastosowana implementacja opiera się na głębokiej sieci neuronowej jako aproksymatorze funkcji Q. Jest wyposażona w pamięć powtórek \textit{(ang. replay memory)} (patrz \ref{replaymemory}), a do eksploracji używana jest metoda e-zachłanna (patrz \ref{egreedy}). Schemat sieci neuronowej jest następujący.
