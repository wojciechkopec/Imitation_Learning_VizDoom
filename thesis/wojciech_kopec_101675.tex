...
}                   % Note how we protect the final title phrase from breaking
...
\input{text/approaches.tex}
\input{text/uncertainty.tex}
...
\bibliographystyle{plalpha}{\raggedright\sloppy\small}
